package com.punuo.sys.app.imgdot.view;
...
import com.punuo.sys.app.imgdot.activity.FdomainActivity;
...
public class ImageLayout extends FrameLayout implements View.OnClickListener {
    ...
    public void onClick(View view) {
     ...
     //   Info.tag = pos;
        ...
        if (clickListener != null) {
            clickListener.onPointClickListener(pos);
        }else {
            System.out.println("clickListener is null");
        }
        if (videoPlayListener != null){
            videoPlayListener.onVideoPlayListener(pos);
        }
    }
   ...
   public void setClickListener(ClickListener listener){
    ...
    public interface ClickListener{
        void onPointClickListener(int tag);
    }

    public void setVideoPlayListener(VideoPlayListener playListener){
        this.videoPlayListener = playListener;
    }
    public interface VideoPlayListener{
        void onVideoPlayListener(int tag);
    }
}
